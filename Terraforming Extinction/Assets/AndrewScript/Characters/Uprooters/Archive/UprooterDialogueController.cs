...
public class UprooterDialogueController : MonoBehaviour
{
    ...
    {
        get => UseStatContainer ? GetComponent<UprooterStateStatContainer>().StateManager.GetState() : LocalState;
        set
        {
    ...
    public void CreateDialogue(DialogueLines[] ReceivedDialogue = null, UprooterStates state = UprooterStates.None)
    {
        //if given value
