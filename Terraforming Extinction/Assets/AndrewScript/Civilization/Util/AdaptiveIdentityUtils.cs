...
//IdentityTracker uses this to manipulate the identifiers and characteristics
//I DON"T THINK I USE THIS ANYMORE. I JUST USE AIF
public static class AdaptiveIdentityUtils
{
    ...
    public static IdentifierNode CopyIdentifierNode(IdentifierNode originalNode)
    {
        ...
        {
            SubIdentifierNode subCopy = new SubIdentifierNode(copyNode)
            {
    ...
    */
    ...
    private static SubIdentifierNode FindSubIdentifierRecursive(IdentifierNode currentNode, SubIdentifierNode targetSubIdentifier)
    {
        ...
        {
            SubIdentifierNode foundInChild = FindSubIdentifierRecursive(childNode, targetSubIdentifier);
            if (foundInChild != null)
            {
