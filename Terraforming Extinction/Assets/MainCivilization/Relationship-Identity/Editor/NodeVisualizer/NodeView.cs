...
public class NodeView
{
    ...
    private RelationshipPersonalTreeSO trackerSO;  // Reference to the tracker scriptable object
    private bool showSubIdentifiers = false;

    private const float Width = 150;
    private const float Height = 50;

    public NodeView(IdentifierNode node, Vector2 position, NodeView parent, RelationshipPersonalTreeSO trackerSO)
    {
        this.node = node;
    ...
    private void AddSubIdentifier()
    {
        ...
        var newSubIdentifier = new SubIdentifierNode(node)
        {
